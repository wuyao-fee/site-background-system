<template>
  <div class="blog-edit-container app-container">
    <!-- 文章标题 -->
...
<script>
import { updateBlogApi, getBlogTypeApi, getBlogByIdApi } from "@/api/blog.js";
...
export default {
  created() {
    ...
    getBlogByIdApi(this.id).then((res) => {
        ...
        console.log(res);
        this.form = res.data;
        this.form.select = res.data.categoryId === null ? '' : res.data.category.id;
