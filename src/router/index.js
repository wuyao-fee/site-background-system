...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        meta: { title: '博客列表', icon: 'el-icon-s-order', auth: true }
      },
      {
        path: 'blogClassify',
        name: 'BlogClassify',
        component: () => import('@/views/blogClassify/index'),
      ...
      },
      {
        ...
        meta: { title: '添加博客', icon: 'el-icon-document-add', auth: true }
      },
      {
        path: 'blogEdit/:id',
        name: 'BlogEdit',
        component: () => import('@/views/blogEdit/index'),
        hidden: true,
        meta: { title: '编辑博客', icon: 'el-icon-document-add', auth: true }
      }
    ]
  },
...

  {
    ...
    children: [{
      ...
      meta: { title: '留言板', icon: 'el-icon-chat-square', auth: true }
    }]
  },
